...
setwd(dir = "C:\\Users\\gianc\\OneDrive\\Desktop\\DATA ANALYSIS\\PROJECTS\\R\\INTRODUCTION TO EDA IN R")
...
qplot(sleeptime, data = df,
      main = "Histrogram for Mammals Sleep Time")
...
boxplot(df$awake, main = "Mammals awake time")
...
qplot(class, hwy, data = df1,
      main = "Highway miles per gallon for class of class",
      xlab = "Class of Cars",
...
ggsave("Colored-dot-plot2.jpeg", den, width = 9, height = 6)